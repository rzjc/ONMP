...
```
 $ sh -c "$(curl -kfsSl https://raw.githubusercontent.com/rzjc/ONMP/master/oneclick.sh)"
```
...
# 下载软件包
wget --no-check-certificate -O /opt/onmp.zip https://github.com/rzjc/ONMP/archive/master.zip 
